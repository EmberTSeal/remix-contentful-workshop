...
export default function Index() {
  return (
    <div className="text-center mt-24 sm:mt-24">
      ...
      <h1 className="text-3xl sm:text-6xl">Hello <span role="img" aria-label="wave">👋</span>, I'm Ember</h1>
      <h2 className="mt-8 text-xl sm:text-3xl">Aspiring Web Dev</h2>
      <div className="mt-8 sm:mt-16 flex justify-evenly sm:mx-64 mx-12">
        {/* Update GitHub Profile Link */}
        <a href="https://github.com/EmberTSeal" aria-label="GitHub Profile Link" target="_blank">
        ...
        <a href="https://linkedin.com/in/trisha-seal" aria-label="LinkedIn Profile Link" target="_blank">
